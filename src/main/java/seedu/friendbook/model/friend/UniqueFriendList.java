 ...
 * A friend is considered unique by comparing using {@code Friend
 * #isSameFriend(Friend)}. As such, adding and updating of
 * friends uses Friend#isSameFriend(Friend) for equality so as to
 * ensure that the friend being added or updated is
 * unique in terms of identity in the UniqueFriendList. However, the removal of a friend uses Friend#equals(Object) so
