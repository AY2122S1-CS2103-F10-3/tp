...
public class AddCommand extends Command {
    ...
    public static final String MESSAGE_SUCCESS = "New friend added: "
            + "%1$s";
    public static final String MESSAGE_DUPLICATE_PERSON = "This "
            + "friend"
            + " already exists in the friend book";
